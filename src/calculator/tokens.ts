 ...
 */
export async function countAnthropicTokens(model: string, text: string): Promise<TokenCountResult> {
 ...
 */
export async function countGoogleTokens(model: string, text: string): Promise<TokenCountResult> {
